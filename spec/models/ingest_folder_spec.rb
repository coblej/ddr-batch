...
module Ddr::Batch
  ...
  RSpec.shared_examples "an invalid ingest folder" do
  ...
  RSpec.shared_examples "a proper set of batch objects" do
  ...
  RSpec.shared_examples "batch objects without an admin policy" do
  ...
  RSpec.shared_examples "batch objects without individual permissions" do
  ...
  RSpec.describe IngestFolder, type: :model, ingest: true do
